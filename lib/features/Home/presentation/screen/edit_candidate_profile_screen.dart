...
class EditCandidateProfileScreen extends StatelessWidget {
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Obx(() {
            ...
            } else if (controller.networkBannerUrl.value != null &&
                controller.networkBannerUrl.value!.isNotEmpty) {
            ...
            child: Obx(() {
              ...
              if (controller.photoPath.value != null) {
                image = FileImage(File(controller.photoPath.value!));
                  ...
                  controller.networkPhotoUrl.value!.isNotEmpty) {
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: _buildTextField('Last Name', controller.surnameController),
            ),
          ],
        ),
        const SizedBox(height: 16),
        ...
        Obx(
          () => CheckboxListTile(
            ...
            onChanged: (val) =>
                controller.immediatelyAvailable.value = val ?? false,
      ...
      children: [
        ...
        TextField(
          ...
          onChanged: (text) {
            ...
            controller.aboutMeQuillController.document = Document()
              ..insert(0, text);
          },
        ),
      ],
  ...
  Widget _buildCertificationsSection(
    EditCandidateProfileController controller,
  ) {
    return Obx(
      () => _buildTagsSection(
        'Add a certification',
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          controller: ctrl,
          decoration: InputDecoration(
            prefixIcon: _buildSocialIcon(icon),
            border: const OutlineInputBorder(),
  ...
  Widget _buildSocialIcon(Object icon) {
    if (icon is FaIconData) {
      return FaIcon(icon, size: 18);
    }

    return Icon(icon as IconData, size: 18);
  }
