        ...
        children: [
          ...
          Obx(() {
            ...
            return GestureDetector(
              onTap: controller.isUploading.value ? null : controller.pickAndUploadVideo,
              child: Container(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            // Progress bar
                            Obx(() {
                              final progress = controller.totalDuration.value
                                  .inMilliseconds ==
                                  0
                                  ? 0.0
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: recruiterController.isLoading.value
                  ? null
                  : () => recruiterController.uploadVideo(elevatorPitchController),
              style: ElevatedButton.styleFrom(backgroundColor: Colors.blue),
              child: Obx(() => Text(
                recruiterController.isLoading.value ? 'Uploading...' : 'Upload Video',
