...
class Company {
  ...
  factory Company.fromJson(Map<String, dynamic> json) {
    return Company(
      ...
      updatedAt: json['updatedAt'] ?? '',
      elevatorPitch: json['elevatorPitch'] != null
          ? ElevatorPitch.fromJson(json['elevatorPitch'] as Map<String, dynamic>?)
          : null,
    );
  }
}
...
class ElevatorPitch {
  ...
  ElevatorPitch.empty()
      : video = Video(),
        metadata = VideoMetadata(duration: 0, format: '', vcodec: '', width: 0, height: 0),
        processing = Processing(state: '', startedAt: '', completedAt: '', fileSize: 0, fileName: ''),
        id = '',
        userId = '',
        status = '',
        createdAt = '',
...
class Video {
  ...
  factory Video.fromJson(Map<String, dynamic>? json) {
    ...
    return Video(
      ...
      encryptionKeyUrl: json['encryptionKeyUrl'] as String? ?? localPaths?['key'] as String?,
    );
  }
}
